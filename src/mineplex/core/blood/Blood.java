...
public class Blood extends MiniPlugin implements Serializable
{
	...
	{
		Effects(event.getEntity(), event.getEntity().getEyeLocation(), 10, 0.5, Sound.ENTITY_PLAYER_HURT, 1f, 1f, Material.INK_SAC, (byte)1, true);
	}
