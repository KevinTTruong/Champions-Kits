...
public class ProjectileManager extends MiniPlugin implements Serializable
{
	private SerializableWeakHashMap<Entity, ProjectileUser> _thrown = new SerializableWeakHashMap<Entity, ProjectileUser>();
