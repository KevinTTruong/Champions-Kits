...
public class ItemFactory extends MiniPlugin implements IItemFactory, Serializable
{
	...
	private void PopulateFactory(String webAddress)
	{
	    ...
	    AddConsumables();
	    AddPassive();		//Doesn't do anything anyway
	    AddThrowable();
	    AddTools();		//Doesn't do anything anyway
	    AddOther();
	    //addWeapons();
