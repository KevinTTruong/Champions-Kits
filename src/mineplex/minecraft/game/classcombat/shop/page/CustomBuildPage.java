...
public class CustomBuildPage extends ShopPageBase<ClassShopManager, ClassCombatShop>
{
	...
	public CustomBuildPage(ClassShopManager shopManager, ClassCombatShop shop, CoreClientManager clientManager, Player player)
	{        
		super(shopManager, shop, clientManager, "       Custom Build", player);
...
//					}
	...
	public void EditAndSaveCustomBuild(CustomBuildToken customBuild)
	{
		...
		getShop().openPageForPlayer(getPlayer(), new SkillPage(getPlugin(), getShop(), getClientManager(), getPlayer(), _pvpClass));
	}
