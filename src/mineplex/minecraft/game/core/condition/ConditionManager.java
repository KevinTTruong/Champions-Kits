...
import nautilus.game.arcade.serialized.SerializableWeakHashMap;

public class ConditionManager extends MiniPlugin implements Serializable
{
	private ConditionFactory _factory;
	//private ConditionApplicator _applicator;
	protected ConditionEffect Effect;

	private SerializableWeakHashMap<LivingEntity, LinkedList<Condition>> _conditions = new SerializableWeakHashMap<LivingEntity, LinkedList<Condition>>();
	private SerializableWeakHashMap<LivingEntity, LinkedList<ConditionActive>> _activeConditions = new SerializableWeakHashMap<LivingEntity, LinkedList<ConditionActive>>();
	...
	*/
	...
	public SerializableWeakHashMap<LivingEntity, LinkedList<ConditionActive>> GetActiveConditions()
	{
